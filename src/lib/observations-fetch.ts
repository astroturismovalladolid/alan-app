...
export interface Observation {
  id: string;
  imageUrl: string; // Original full-resolution image (for scientific downloads)
  thumbnailUrl?: string; // Optimized WebP thumbnail for UI display (generated by Firebase extension)
  latitude: number;
  longitude: number;
  description: string;
  rating: number;
  ...
  try {
    ...
    querySnapshot.forEach((doc) => {
      ...
      observations.push({
        ...
        thumbnailUrl: data.thumbnailUrl, // Optimized thumbnail (if available)
